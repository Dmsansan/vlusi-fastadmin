...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-daily_categroy_id" data-rule="required" data-source="daily/categroy/index" class="form-control selectpage form-control" name="row[daily_categroy_id]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-coverimage" data-rule="required" class="form-control form-control" size="50" name="row[coverimage]" type="text" value="">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-videofile" class="form-control form-control" size="50" name="row[videofile]" type="text" value="">
                <div class="input-group-addon no-border no-padding">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-comments" data-rule="required" class="form-control form-control" name="row[comments]" type="number" value="0">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Auth'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-auth" data-rule="required" class="form-control form-control" name="row[auth]" type="text" value="乐养居">
        </div>
    </div>
