<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:93:"D:\phpStudy\PHPTutorial\WWW\vlusi_fastadmin\public/../application/admin\view\index\index.html";i:1541402489;s:83:"D:\phpStudy\PHPTutorial\WWW\vlusi_fastadmin\application\admin\view\common\meta.html";i:1541402489;s:85:"D:\phpStudy\PHPTutorial\WWW\vlusi_fastadmin\application\admin\view\common\header.html";i:1541402489;s:83:"D:\phpStudy\PHPTutorial\WWW\vlusi_fastadmin\application\admin\view\common\menu.html";i:1541402489;s:86:"D:\phpStudy\PHPTutorial\WWW\vlusi_fastadmin\application\admin\view\common\control.html";i:1541402489;s:85:"D:\phpStudy\PHPTutorial\WWW\vlusi_fastadmin\application\admin\view\common\script.html";i:1541402489;}*/ ?>
<!DOCTYPE html>
    ...
    <div id="firstnav">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a href="/vlusi_fastadmin/public/" target="_blank"><i class="fa fa-home" style="font-size:14px;"></i></a>
                </li>
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="/vlusi_fastadmin/public<?php echo $admin['avatar']; ?>" class="user-image" alt="<?php echo $admin['nickname']; ?>">
                        <span class="hidden-xs"><?php echo $admin['nickname']; ?></span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            <img src="/vlusi_fastadmin/public<?php echo $admin['avatar']; ?>" class="img-circle" alt="">
...
<section class="sidebar">
    ...
    <div class="user-panel hidden-xs">
        <div class="pull-left image">
            <a href="general/profile" class="addtabsit"><img src="/vlusi_fastadmin/public<?php echo $admin['avatar']; ?>" class="img-circle" /></a>
        </div>
