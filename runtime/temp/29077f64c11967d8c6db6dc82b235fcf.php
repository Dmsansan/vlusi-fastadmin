<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:93:"D:\phpStudy\PHPTutorial\WWW\vlusi_fastadmin\public/../application/admin\view\index\login.html";i:1540455581;s:83:"D:\phpStudy\PHPTutorial\WWW\vlusi_fastadmin\application\admin\view\common\meta.html";i:1536636085;s:85:"D:\phpStudy\PHPTutorial\WWW\vlusi_fastadmin\application\admin\view\common\script.html";i:1536636085;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
                ...
                <div class="login-screen">
                    <div class="well">
                        <div class="login-form">
                            <img id="profile-img" class="profile-img-card" src="/vlusi_fastadmin/public/assets/img/avatar.png" />
                            ...
                            <form action="" method="post" id="login-form">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-addon" style="padding:0;border:none;cursor:pointer;">
                                        <img src="<?php echo rtrim('/vlusi_fastadmin/public/', '/'); ?>/captcha" width="100" height="30" onclick="this.src = '<?php echo rtrim('/vlusi_fastadmin/public/', '/'); ?>/captcha?r=' + Math.random();"/>
                                    </span>
                                </div>
                                <?php endif; ?>
